...
$(document).ready(function(){
  ...
  socket.on("postResponse", function (doc){
...
function addNewLineBefore(submission){
  ...
  var newElem = dom("div", {id:"boarder", class:"boarder"},
          dom("div",{id:"dropdown"},
            ...
            dom("p",{id:"url"}, 
              document.createTextNode("Link to post: "), dom("a", {href:"/post" + submission.id}, "spotted.me/post" + submission.id) 
            )
          )
      );
